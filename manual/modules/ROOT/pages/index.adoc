...
This supplies a deliberately conservative navigation constraint.
...
*Fix…* can now propagate visible observations along a COG/SOG model to a common
epoch and solve them numerically without changing the stored raw sight times.
