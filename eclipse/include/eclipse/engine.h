...
struct EclipseEvent {
  ...
  EclipseEvent()
      : type(kPartialEclipse), maximum_tt_jd(0.0), delta_t_seconds(0.0),
        axis_distance_km(0.0), magnitude(0.0) {}
};
...
struct ContactTime {
  ...
  ContactTime() : valid(false), tt_jd(0.0), sun_altitude_deg(0.0),
                  sun_azimuth_deg(0.0) {}
};
...
struct LocalContacts {
  ...
  LocalContacts() : type(kPartialEclipse), magnitude(0.0), obscuration(0.0),
