...
namespace {
const Data _tbl[] = {{0, 0, 0, 0, 1, -171996, -1742, 92025, 89},
...
void _constants(double T, double& D, double& M, double& M1, double& F,
  ...
  // Constant terms.
  //
  static const double _kD[] = {d_to_r(297.85036), d_to_r(445267.111480),
                               d_to_r(-0.0019142), d_to_r(1.0 / 189474)};
  static const VECTOR(kD, double);

  static const double _kM[] = {d_to_r(357.52772), d_to_r(35999.050340),
                               d_to_r(-0.0001603), d_to_r(-1.0 / 300000)};
  static const VECTOR(kM, double);

  static const double _kM1[] = {d_to_r(134.96298), d_to_r(477198.867398),
                                d_to_r(0.0086972), d_to_r(1.0 / 56250)};
  static const VECTOR(kM1, double);

  static const double _kF[] = {d_to_r(93.27191), d_to_r(483202.017538),
                               d_to_r(-0.0036825), d_to_r(1.0 / 327270)};
  static const VECTOR(kF, double);

  static const double _ko[] = {d_to_r(125.04452), d_to_r(-1934.136261),
                               d_to_r(0.0020708), d_to_r(1.0 / 450000)};
...
double astrolabe::nutation::nut_in_lon(double jd) {
  ...
  */
  ...
  for (std::vector<Data>::const_iterator p = tbl.begin(); p != tbl.end(); ++p) {
    const double arg =
        D * p->D + M * p->M + M1 * p->M1 + F * p->F + omega * p->omega;
...
double astrolabe::nutation::obliquity(double jd) {
  ...
  */
  ...
  static const double _el0[] = {
      d_to_r(dms_to_d(23, 26, 21.448)), d_to_r(dms_to_d(0, 0, -46.8150)),
...
double astrolabe::nutation::obliquity_hi(double jd) {
  ...
  */
  ...
  static const double _el1[] = {
      d_to_r(dms_to_d(23, 26, 21.448)), d_to_r(dms_to_d(0, 0, -4680.93)),
      d_to_r(dms_to_d(0, 0, -1.55)),    d_to_r(dms_to_d(0, 0, 1999.25)),
      d_to_r(dms_to_d(0, 0, -51.38)),   d_to_r(dms_to_d(0, 0, -249.67)),
      d_to_r(dms_to_d(0, 0, -39.05)),   d_to_r(dms_to_d(0, 0, 7.12)),
      d_to_r(dms_to_d(0, 0, 27.87)),    d_to_r(dms_to_d(0, 0, 5.79)),
